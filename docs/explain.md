...
*   **$\frac{\partial L}{\partial y_j}$ (Post-Synaptic Error Signal):** In biology, we look at post-synaptic firing. In Deep Learning, we look at the \textbf{gradient}. This term tells us: \textit{``How sensitive is the overall loss $L$ to the activity of neuron $j$ ($y_j$)?''}
