...
comparison_files = {
    'DADP (Hebbian)': 'results/resnet18_cifar10_experiments/history_hebbian_resnet18_CIFAR10_thr5e-06_dt500.json',
    'Magnitude': 'results/resnet18_cifar10_experiments/history_magnitude_resnet18_CIFAR10_sp0.9.json',
    'SNIP': 'results/resnet18_cifar10_experiments/history_snip_resnet18_CIFAR10_sp0.9.json',
    'RigL': 'results/resnet18_cifar10_experiments/history_rigl_resnet18_CIFAR10_sp0.9.json'
}
...
ax1.set_title('Layer-wise Capacity Distribution\nActive Weights to Total Weights Ratio (~90% Global Sparsity)', fontsize=12, fontweight='bold')
...
ax2.set_title('Layer-wise Neuron Retention\nActive Neurons to Total Neurons Ratio (~90% Global Sparsity)', fontsize=12, fontweight='bold')
...
# Save image
output_path = 'results/resnet18_cifar10_experiments/resnet18_cifar10_layer_wise_comparison.png'
