...
ax1.set_title('Layer-wise Capacity Distribution\nActive Weights to Total Weights Ratio (~99% Global Sparsity)', fontsize=11, fontweight='bold')
...
ax2.set_title('Layer-wise Neuron Retention\nActive Neurons to Total Neurons Ratio (~99% Global Sparsity)', fontsize=11, fontweight='bold')
