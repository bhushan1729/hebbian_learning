...
plt.title('BERT-Tiny SST-2 Accuracy Trade-off vs. Sparsity\nRelative Accuracy Change from Dense Baseline (10 Epochs)', fontsize=12, fontweight='bold', pad=12)
...
# Save the plot
output_path = 'plots/bert_tiny_sst2_accuracy_loss_comparison.png'
os.makedirs(os.path.dirname(output_path), exist_ok=True)
plt.savefig(output_path, bbox_inches='tight', dpi=300)
plt.close()

print(f"BERT-Tiny accuracy loss trade-off plot successfully saved to {output_path}")
